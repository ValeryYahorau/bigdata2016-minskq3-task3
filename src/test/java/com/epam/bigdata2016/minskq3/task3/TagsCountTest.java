...
public class TagsCountTest {
    ...
    private final String input2 = "282163091263 Bmw,Mercedes,Mazda ON CPC BROAD http://dummy.com";
    private final String input3 = "282163091263 MERCEDES,MAZDA ON CPC BROAD http://dummy.com";
    private final String input4 = "282163091263 MAZDA ON CPC BROAD http://dummy.com";
    ...
    public void testReducer() throws IOException {
        ...
        reduceDriver.withOutput(new Text(s4), new IntWritable(4));
    ...
    public void testMapReduce() throws IOException {
        ...
        mapReduceDriver.withOutput(new Text(s2), new IntWritable(2));
        mapReduceDriver.withOutput(new Text(s4), new IntWritable(4));
        mapReduceDriver.withOutput(new Text(s3), new IntWritable(3));
